...
const covid19ImpactEstimator = (data) => {
  ...
  impact.dollarsInFlight = Math.trunc(impact.infectionsByRequestedTime * population * 4) / days;
  severeImpact.dollarsInFlight = Math.trunc(severeInfectionsByRequestedTime * population * 4) / days;
