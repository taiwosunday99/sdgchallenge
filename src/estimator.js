...
const covid19ImpactEstimator = (data) => {
  ...
  impact.dollarsInFlight = Math.trunc(impact.infectionsByRequestedTime * population * 4) / 30;
  severeImpact.dollarsInFlight = Math.trunc(severeInfectionsByRequestedTime * population * 4) / 30;
