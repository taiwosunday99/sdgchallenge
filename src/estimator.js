...
const covid19ImpactEstimator = (data) => {
  ...
  impact.dollarsInFlight = Math.trunc(impact.infectionsByRequestedTime * 0.65 * 1.5) / days;
  severeImpact.dollarsInFlight = Math.trunc(severeInfectionsByRequestedTime * 0.65 * 1.5) / days;
